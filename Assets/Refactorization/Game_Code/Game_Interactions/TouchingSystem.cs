...
public class TouchingSystem : MonoBehaviour
{
    ...
    public void ActionMoveMobToTile(DefaultTile defaultTileTouched)
    {
        ...
        Vector3 targetPosition = new Vector3(tilePosition.x, vectorYHeightGivenTile(defaultTileTouched, selectedMob), tilePosition.z);  // Use selectedMob's current Y
    ...
    public void ActionMoveMobToBuilding(DefaultBuild defaultBuildTouched)
    {
        ...
        Vector3 targetPosition = new Vector3(buildingPosition.x, vectorYHeightGivenTile(defaultBuildTouched.GetTile(), selectedMob), buildingPosition.z);
        selectedMob.RemoveFromBuilding();
